...
module.exports = function() {
	...
	_helpers.isAdminEditorCSS = function(options) {
		var output = '';
	...
	_helpers.themes = function(currentTheme) {
	...
	_helpers.isActiveTheme = function(itemA, itemB) {
		if (itemA === itemB) {
			return 'active';
		} else {
			return '';
	...
	_helpers.isEquals = function(itemA, itemB) {
		if (itemA === itemB) {
			return true;
		} else {
			return false;
	...
	_helpers.isActiveCategory = function(itemA, itemB) {
		if (itemA === itemB) {
			return 'active';
		} else {
			return '';
	...
	_helpers.isAllActiveCategory = function(itemA) {
	...
	// Direct url link to a specific product
	_helpers.topSellerURL = function(topSellerSlug, options) {
		return ('/top-seller/' + topSellerSlug);
	};

	// Direct url link to a specific product
	_helpers.tagURL = function(topSellerSlug, options) {
		return ('/search/' + topSellerSlug);
	};
